...
class TestCourier:
    ...
    def test_create_courier_missing_fields(self, api_client):
        ...
        with allure.step("Проверка ответа на запрос с отсутствующими обязательными полями"):
    ...
    def test_login_courier_invalid_credentials(self, api_client):
        ...
        with allure.step("Отправка запроса с неверными логином и паролем"):
    ...
    def test_delete_courier_nonexistent_id(self, api_client):
        ...
        with allure.step("Проверка ответа на запрос с несуществующим ID"):
